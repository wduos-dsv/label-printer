...
Mt.handle("print-position-label", async (e, t) => {
  try {
    ...
    return await cn(n, r, a), { success: !0 };
  } catch (n) {
    return { success: !1, error: n.message };
  }
});
